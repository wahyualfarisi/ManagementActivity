...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Sistem Management </b><small>Activity</small></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan Login Disini</p>

    <form name="loginForm" action="<?= base_url('login/loginaction') ?>" method="post" novalidate>
            <?php
      ...
      <div class="form-group has-feedback">
        ...
        <span style="color:red" ng-show="loginForm.email.$dirty && loginForm.email.$invalid">
              <span ng-show="loginForm.email.$error.required">Email Harus diisi</span>
              <span ng-show ="loginForm.email.$error.email">Email Tidak Dikenal</span>
        </span>
      ...
      <div class="form-group has-feedback">
        ...
        <span style="color:red" ng-show="loginForm.password.$dirty && loginForm.password.$invalid">
              <span ng-show="loginForm.password.$error.required">Password Harus Diisi</span>
        </span>
